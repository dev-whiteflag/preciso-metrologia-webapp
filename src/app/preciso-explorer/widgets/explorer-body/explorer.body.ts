            ...
            if (selectedCert != null){
              ...
              switch (selectedCert.map((data => data["Tipo de Instrumento"])).toString()){
                case "Medidor de Pressão":
                  ...
                  workbook.sheet(0).cell('AT44').value((selectedCert.map(data => data.Padrão)).toString());
                ...
                workbook.sheet(0).cell('AU65').value((selectedCert.map(data => data.Padrão)).toString());
                workbook.sheet(0).cell('AU66').value((selectedCert.map(data => data.Padrão)).toString());
                workbook.sheet(0).cell('AU67').value((selectedCert.map(data => data.Padrão)).toString());
                ...
                case "Vidraria Graduada":
                 workbook.sheet(0).cell('AV3').value((selectedCert.map(data => data.Ano)).toString());
                  ...
                  workbook.sheet(0).cell('AT33').value((selectedCert.map(data => data.Padrão)).toString());
                  workbook.sheet(0).cell('AT34').value((selectedCert.map(data => data.Padrão)).toString());
                  workbook.sheet(0).cell('AT35').value((selectedCert.map(data => data.Padrão)).toString());
